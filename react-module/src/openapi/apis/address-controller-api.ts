...
export const AddressControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getAddress: async (id: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling getAddress.');
            }
            const localVarPath = `/api/address/get/{id}`
...
export class AddressControllerApi extends BaseAPI {
    ...
    public getAddress(id: number, options?: any) {
        return AddressControllerApiFp(this.configuration).getAddress(id, options).then((request) => request(this.axios, this.basePath));
    }
}
