 ...
 * 
 * @export
 * @interface ActionResourceListCustomFile
 */
export interface ActionResourceListCustomFile {
    /**
     * 
     * @type {string}
     * @memberof ActionResourceListCustomFile
     */
    actionResourceStatus?: ActionResourceListCustomFileActionResourceStatusEnum;
    /**
     * 
     * @type {Array&lt;CustomFile&gt;}
     * @memberof ActionResourceListCustomFile
     */
    resource?: any;
}
...
/**
    ...
    * @enum {string}
    */
export enum ActionResourceListCustomFileActionResourceStatusEnum {
    OK = 'OK',
