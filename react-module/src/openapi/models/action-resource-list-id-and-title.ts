 ...
 * 
 * @export
 * @interface ActionResourceListIdAndTitle
 */
export interface ActionResourceListIdAndTitle {
    /**
     * 
     * @type {string}
     * @memberof ActionResourceListIdAndTitle
     */
    actionResourceStatus?: ActionResourceListIdAndTitleActionResourceStatusEnum;
    /**
     * 
     * @type {Array&lt;IdAndTitle&gt;}
     * @memberof ActionResourceListIdAndTitle
     */
    resource?: any;
}
...
/**
    ...
    * @enum {string}
    */
export enum ActionResourceListIdAndTitleActionResourceStatusEnum {
    OK = 'OK',
