 ...
 * 
 * @export
 * @interface ActionResourceListUniversityDto
 */
export interface ActionResourceListUniversityDto {
    /**
     * 
     * @type {string}
     * @memberof ActionResourceListUniversityDto
     */
    actionResourceStatus?: ActionResourceListUniversityDtoActionResourceStatusEnum;
    /**
     * 
...
/**
    ...
    * @enum {string}
    */
export enum ActionResourceListUniversityDtoActionResourceStatusEnum {
    OK = 'OK',
