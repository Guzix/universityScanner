 ...
 * 
 * @export
 * @interface ActionResourcePageUniversityDto
 */
export interface ActionResourcePageUniversityDto {
    /**
     * 
     * @type {string}
     * @memberof ActionResourcePageUniversityDto
     */
    actionResourceStatus?: ActionResourcePageUniversityDtoActionResourceStatusEnum;
    /**
     * 
     * @type {PageUniversityDto}
     * @memberof ActionResourcePageUniversityDto
     */
    resource?: any;
}
...
/**
    ...
    * @enum {string}
    */
export enum ActionResourcePageUniversityDtoActionResourceStatusEnum {
    OK = 'OK',
