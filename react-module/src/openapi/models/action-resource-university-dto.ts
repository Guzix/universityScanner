 ...
 * 
 * @export
 * @interface ActionResourceUniversityDto
 */
export interface ActionResourceUniversityDto {
    /**
     * 
     * @type {string}
     * @memberof ActionResourceUniversityDto
     */
    actionResourceStatus?: ActionResourceUniversityDtoActionResourceStatusEnum;
    /**
     * 
     * @type {UniversityDto}
     * @memberof ActionResourceUniversityDto
...
/**
    ...
    * @enum {string}
    */
export enum ActionResourceUniversityDtoActionResourceStatusEnum {
    OK = 'OK',
