 ...
 * 
 * @export
 * @interface ActionResourceUserMLDto
 */
export interface ActionResourceUserMLDto {
    /**
     * 
     * @type {string}
     * @memberof ActionResourceUserMLDto
     */
    actionResourceStatus?: ActionResourceUserMLDtoActionResourceStatusEnum;
    /**
     * 
     * @type {UserMLDto}
     * @memberof ActionResourceUserMLDto
...
/**
    ...
    * @enum {string}
    */
export enum ActionResourceUserMLDtoActionResourceStatusEnum {
    OK = 'OK',
