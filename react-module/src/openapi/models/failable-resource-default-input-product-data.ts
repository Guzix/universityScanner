 ...
 * 
 * @export
 * @interface FailableResourceDefaultInputProductData
 */
export interface FailableResourceDefaultInputProductData {
    /**
     * 
     * @type {boolean}
     * @memberof FailableResourceDefaultInputProductData
     */
    success?: any;
    /**
     * 
     ...
     * @memberof FailableResourceDefaultInputProductData
     */
    status?: FailableResourceDefaultInputProductDataStatusEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum FailableResourceDefaultInputProductDataStatusEnum {
    OK = 'OK',
