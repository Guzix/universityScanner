 ...
 * 
 * @export
 * @interface FailableResourceLayerShapeExtendedDto
 */
export interface FailableResourceLayerShapeExtendedDto {
    /**
     * 
     * @type {boolean}
     * @memberof FailableResourceLayerShapeExtendedDto
     */
    success?: any;
    /**
     * 
     ...
     * @memberof FailableResourceLayerShapeExtendedDto
     */
    status?: FailableResourceLayerShapeExtendedDtoStatusEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum FailableResourceLayerShapeExtendedDtoStatusEnum {
    OK = 'OK',
