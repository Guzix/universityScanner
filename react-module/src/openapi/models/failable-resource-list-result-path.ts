 ...
 * 
 * @export
 * @interface FailableResourceListResultPath
 */
export interface FailableResourceListResultPath {
    /**
     * 
     * @type {boolean}
     * @memberof FailableResourceListResultPath
     */
    success?: any;
    /**
     * 
     ...
     * @memberof FailableResourceListResultPath
     */
    status?: FailableResourceListResultPathStatusEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum FailableResourceListResultPathStatusEnum {
    OK = 'OK',
