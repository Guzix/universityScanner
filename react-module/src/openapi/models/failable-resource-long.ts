 ...
 * 
 * @export
 * @interface FailableResourceLong
 */
export interface FailableResourceLong {
    /**
     * 
     * @type {boolean}
     * @memberof FailableResourceLong
     */
    success?: any;
    /**
     * 
     ...
     * @memberof FailableResourceLong
     */
    status?: FailableResourceLongStatusEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum FailableResourceLongStatusEnum {
    OK = 'OK',
