 ...
 * 
 * @export
 * @interface FailableResourceNonErpOrderExtendedDto
 */
export interface FailableResourceNonErpOrderExtendedDto {
    /**
     * 
     * @type {boolean}
     * @memberof FailableResourceNonErpOrderExtendedDto
     */
    success?: any;
    /**
     * 
     ...
     * @memberof FailableResourceNonErpOrderExtendedDto
     */
    status?: FailableResourceNonErpOrderExtendedDtoStatusEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum FailableResourceNonErpOrderExtendedDtoStatusEnum {
    OK = 'OK',
