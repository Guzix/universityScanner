 ...
 * 
 * @export
 * @interface FailableResourceOperationTimeBasicDto
 */
export interface FailableResourceOperationTimeBasicDto {
    /**
     * 
     * @type {boolean}
     * @memberof FailableResourceOperationTimeBasicDto
     */
    success?: any;
    /**
     * 
     ...
     * @memberof FailableResourceOperationTimeBasicDto
     */
    status?: FailableResourceOperationTimeBasicDtoStatusEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum FailableResourceOperationTimeBasicDtoStatusEnum {
    OK = 'OK',
