 ...
 * 
 * @export
 * @interface FailableResourcePackExtendedDto
 */
export interface FailableResourcePackExtendedDto {
    /**
     * 
     * @type {boolean}
     * @memberof FailableResourcePackExtendedDto
     */
    success?: any;
    /**
     * 
     ...
     * @memberof FailableResourcePackExtendedDto
     */
    status?: FailableResourcePackExtendedDtoStatusEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum FailableResourcePackExtendedDtoStatusEnum {
    OK = 'OK',
