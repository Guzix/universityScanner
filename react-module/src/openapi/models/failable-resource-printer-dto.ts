 ...
 * 
 * @export
 * @interface FailableResourcePrinterDto
 */
export interface FailableResourcePrinterDto {
    /**
     * 
     * @type {boolean}
     * @memberof FailableResourcePrinterDto
     */
    success?: any;
    /**
     * 
     ...
     * @memberof FailableResourcePrinterDto
     */
    status?: FailableResourcePrinterDtoStatusEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum FailableResourcePrinterDtoStatusEnum {
    OK = 'OK',
