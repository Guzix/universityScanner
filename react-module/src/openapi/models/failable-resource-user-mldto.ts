 ...
 * 
 * @export
 * @interface FailableResourceUserMLDto
 */
export interface FailableResourceUserMLDto {
    /**
     * 
     * @type {boolean}
     * @memberof FailableResourceUserMLDto
     */
    success?: any;
    /**
     * 
     ...
     * @memberof FailableResourceUserMLDto
     */
    status?: FailableResourceUserMLDtoStatusEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum FailableResourceUserMLDtoStatusEnum {
    OK = 'OK',
