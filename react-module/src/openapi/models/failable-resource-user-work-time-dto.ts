 ...
 * 
 * @export
 * @interface FailableResourceUserWorkTimeDto
 */
export interface FailableResourceUserWorkTimeDto {
    /**
     * 
     * @type {boolean}
     * @memberof FailableResourceUserWorkTimeDto
     */
    success?: any;
    /**
     * 
     ...
     * @memberof FailableResourceUserWorkTimeDto
     */
    status?: FailableResourceUserWorkTimeDtoStatusEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum FailableResourceUserWorkTimeDtoStatusEnum {
    OK = 'OK',
