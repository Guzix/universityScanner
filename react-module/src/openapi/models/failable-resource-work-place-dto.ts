 ...
 * 
 * @export
 * @interface FailableResourceWorkPlaceDto
 */
export interface FailableResourceWorkPlaceDto {
    /**
     * 
     * @type {boolean}
     * @memberof FailableResourceWorkPlaceDto
     */
    success?: any;
    /**
     * 
     ...
     * @memberof FailableResourceWorkPlaceDto
     */
    status?: FailableResourceWorkPlaceDtoStatusEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum FailableResourceWorkPlaceDtoStatusEnum {
    OK = 'OK',
